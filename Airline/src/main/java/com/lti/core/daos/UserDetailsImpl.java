...
@Repository
public class UserDetailsImpl implements UserDao {
...
*/
	...
	public List<UserDetails> isValid(UserDetails userDetails) {
		...
		for(UserDetails v:user1) {v.getEmail();}
	...
	@Override
	public void addPassengers(PassengerDetails passengerDetails) throws HrExceptions {
